...
public class OAuth2AuthorizationServerJackson2Module extends SimpleModule {
    ...
    public void setupModule(SetupContext context) {
        ...
        // FAIP-284 Handles class types for to handle the new CDR fields “account_id“ and “sharing_expires_at“
        context.setMixInAnnotations((new String[0]).getClass(), StringArrayMixin.class);
